<?php
    ...
    **************************************************************************************************************************/
    ...
    class AlloHelper
    {
        ...
        private static $allocine_url = array(
            'search'			=> array( 'rest/v3/search', 		'search' ),
            'movie'			=> array( 'rest/v3/movie', 		'movie' ),
            'episode'			=> array( 'rest/v3/episode', 		'episode' ),
            'season'			=> array( 'rest/v3/season', 		'season' ),
            'tvserie'			=> array( 'rest/v3/tvseries', 		'tvseries' ),
            'filmography'		=> array( 'rest/v3/filmography', 	'person' ),
            'media'			=> array( 'rest/v3/media', 		'media' ),
            'person' 			=> array( 'rest/v3/person', 		'person' ),
            'news'			=> array( 'rest/v3/news', 		'news' ),
            'showtimesByTheaters' 	=> array( 'rest/v3/showtimelist', 	'feed' ),
            'showtimesByPosition' 	=> array( 'rest/v3/showtimelist', 	'feed' ),
            'showtimesByZip'  		=> array( 'rest/v3/showtimelist', 	'feed' ),
            'movielist'  		=> array( 'rest/v3/movielist', 		'feed' ),
            'reviewlist'  		=> array( 'rest/v3/reviewlist', 	'feed' )
	);
        ...
        protected function creatURL($qtype)
        {
		$this->set(array(
			'format' => 'json',
		...
		$queryURL 	= $this->APIUrl . '/' . self::$allocine_url[$qtype][0];
        ...
        **************************************************************************************************************************/
        ...
        protected function getData($qtype, &$url)
        {
            
            $type       = self::$allocine_url[$qtype][0];
            $container  = self::$allocine_url[$qtype][1];
            
            // Récupération des données
            $data = $this->getDataFromURL($url = $this->creatURL($qtype));
        ...
        public function reviewlist($code, $filter='press', $type='movie', $count = 10, $page = 1, &$url = null)
        {
            ...
            return $this->getData('reviewlist', $url);
        }
        ...
        public function movielist($filter=array('nowshowing'), $order=array('dateasc'), $count = 10, $page = 1, &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('movielist', $url);
        }
        ...
        public function showtimesByZip($zip, $date=null, $movieCode=null, $count = 10, $page = 1, &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('showtimesByZip', $url);
        }
        ...
        public function showtimesByPosition($lat, $long, $radius=10, $date=null, $movieCode=null, $count = 10, $page = 1, &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('showtimesByPosition', $url);
        }
        ...
        public function showtimesByTheaters($theaters, $date=null, $movieCode=null, $count = 10, $page = 1, &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('showtimesByTheaters', $url);
        }
        ...
        public function prepare($code, $profile = 'medium')
        {
        ...
        public function movie($code, $profile = 'medium', &$url = null)
        {
            ...
            $profile = $this->prepare($code, $profile);
                       
            // Création de l'URL
            $url = $this->creatURL('movie');
        ...
        public function person($code, $profile = 'medium', &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('person', $url);
        }
        ...
        public function filmography($code, $profile = 'medium', &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('filmography', $url);
        }
        ...
        public function tvserie($code, $profile = 'medium', &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('tvserie', $url);
        }
        ...
        **************************************************************************************************************************/
        ...
        public function season($code, $profile = 'medium', &$url = null)
        {
            ...
            // Récupération et revoi des données
            return $this->getData('season', $url);
        }
